...
class BiasCelebA(VisionDataset):
    ...
    def __init__(
        ...
        if not os.path.exists(bias_celeba_path):
            if version == 1:
                from dildatasets.bias_celeba_utils.create_celeba_split1 import process_split
            elif version == 2:
                from dildatasets.bias_celeba_utils.create_celeba_split2 import process_split
            else:
